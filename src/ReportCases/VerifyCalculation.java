...
public class VerifyCalculation extends TestBase {
...
String balanceval= driver.findElement(By.xpath(xpath1+i+xbalance)).getAttribute("value");
		...
		Double Backlog = Double.parseDouble(backlog);
			...
			Double ActualBalance = (Backlog + Recieved)
					- (Coded + Discard + Pending);
			System.out.println((Backlog + Recieved)
					- (Coded + Discard + Pending));
			Assert.assertTrue(Balance.equals(ActualBalance),
					"Not able to verified Balance");
